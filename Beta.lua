...
local Themes = {
	...
	Lemon = {
	    Name = "Lemon",
	    Accent = Color3.fromRGB(255, 212, 59), -- Bold lemon yellow
	    AcrylicMain = Color3.fromRGB(40, 40, 30), -- Deep muted background for contrast
	    AcrylicBorder = Color3.fromRGB(85, 70, 30), -- Earthy yellow-brown border
	    AcrylicGradient = ColorSequence.new(Color3.fromRGB(50, 50, 40), Color3.fromRGB(35, 35, 25)),
	    AcyclicNoise = 0.4,
	    TitleBarLine = Color3.fromRGB(255, 212, 59),
	    Tab = Color3.fromRGB(120, 100, 40), -- Muted yellow-brown tab
	    Element = Color3.fromRGB(255, 199, 0), -- Bold lemon
	    ElementBorder = Color3.fromRGB(90, 70, 20),
	    InElementBorder = Color3.fromRGB(120, 100, 30),
	    ElementTransparency = 0.87,
	    ToggleSlider = Color3.fromRGB(255, 199, 0),
	    ToggleToggled = Color3.fromRGB(180, 150, 40),
	    SliderRail = Color3.fromRGB(160, 140, 40),
	    DropdownFrame = Color3.fromRGB(60, 60, 45),
	    DropdownHolder = Color3.fromRGB(50, 50, 35),
	    DropdownBorder = Color3.fromRGB(85, 70, 30),
	    DropdownOption = Color3.fromRGB(255, 212, 59),
	    Keybind = Color3.fromRGB(220, 180, 40),
	    Input = Color3.fromRGB(255, 199, 0),
	    InputFocused = Color3.fromRGB(40, 40, 30),
	    InputIndicator = Color3.fromRGB(255, 232, 100),
	    Dialog = Color3.fromRGB(40, 40, 30),
	    DialogHolder = Color3.fromRGB(50, 50, 35),
	    DialogHolderLine = Color3.fromRGB(85, 70, 30),
	    DialogButton = Color3.fromRGB(255, 212, 59),
	    DialogButtonBorder = Color3.fromRGB(85, 70, 30),
	    DialogBorder = Color3.fromRGB(85, 70, 30),
	    DialogInput = Color3.fromRGB(220, 180, 40),
	    DialogInputLine = Color3.fromRGB(255, 212, 59),
	    Text = Color3.fromRGB(255, 255, 255),
	    SubText = Color3.fromRGB(160, 160, 160),
	    Hover = Color3.fromRGB(255, 232, 120),
	    HoverChange = 0.06
	}
}
