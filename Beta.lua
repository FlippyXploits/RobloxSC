...
local Themes = {
	...
	Lemon = {
	    ...
	    AcrylicBorder = Color3.fromRGB(120, 110, 60), -- Earthy yellow-brown edge
	    AcrylicGradient = ColorSequence.new(Color3.fromRGB(40, 40, 20), Color3.fromRGB(50, 50, 25)),
	    AcyclicNoise = 0.6,
	    TitleBarLine = Color3.fromRGB(255, 239, 100),
	    Tab = Color3.fromRGB(150, 140, 70),
	    Element = Color3.fromRGB(255, 239, 100),
	    ElementBorder = Color3.fromRGB(120, 110, 60),
	    InElementBorder = Color3.fromRGB(140, 130, 70),
	    ElementTransparency = 0.84,
	    ToggleSlider = Color3.fromRGB(255, 245, 120),
	    ToggleToggled = Color3.fromRGB(200, 185, 90),
	    SliderRail = Color3.fromRGB(220, 210, 100),
	    DropdownFrame = Color3.fromRGB(45, 45, 25),
	    DropdownHolder = Color3.fromRGB(40, 40, 20),
	    DropdownBorder = Color3.fromRGB(120, 110, 60),
	    DropdownOption = Color3.fromRGB(255, 239, 100),
	    Keybind = Color3.fromRGB(255, 235, 90),
	    Input = Color3.fromRGB(255, 239, 100),
	    InputFocused = Color3.fromRGB(25, 25, 15),
	    InputIndicator = Color3.fromRGB(255, 255, 140),
	    Dialog = Color3.fromRGB(35, 35, 20),
	    DialogHolder = Color3.fromRGB(40, 40, 20),
	    DialogHolderLine = Color3.fromRGB(120, 110, 60),
	    DialogButton = Color3.fromRGB(255, 239, 100),
	    DialogButtonBorder = Color3.fromRGB(120, 110, 60),
	    DialogBorder = Color3.fromRGB(110, 100, 50),
	    DialogInput = Color3.fromRGB(255, 245, 120),
	    DialogInputLine = Color3.fromRGB(255, 255, 120),
	    Text = Color3.fromRGB(255, 255, 255),
	    SubText = Color3.fromRGB(180, 180, 140),
	    Hover = Color3.fromRGB(255, 250, 150),
	    HoverChange = 0.06
	}
}
