...
me aka FlippyXploits added: Hacker Theme witch discard_owner made. I made lemon theme and mint
]]--   
...
local Themes = {
	...
	Lemon = {
	    Name = "Lemon",
	    Accent = Color3.fromRGB(255, 230, 0), -- Strong lemon yellow
	    AcrylicMain = Color3.fromRGB(25, 25, 0), -- Dark yellow-black mix, like lemon in shadow
	    AcrylicBorder = Color3.fromRGB(90, 90, 0), -- Dull yellow border
	    AcrylicGradient = ColorSequence.new(Color3.fromRGB(30, 30, 0), Color3.fromRGB(40, 40, 0)),
	    AcyclicNoise = 0.7,
	    TitleBarLine = Color3.fromRGB(255, 215, 0),
	    Tab = Color3.fromRGB(120, 120, 0),
	    Element = Color3.fromRGB(255, 220, 0), -- Vibrant
	    ElementBorder = Color3.fromRGB(150, 150, 0),
	    InElementBorder = Color3.fromRGB(120, 120, 0),
	    ElementTransparency = 0.85,
	    ToggleSlider = Color3.fromRGB(255, 230, 0),
	    ToggleToggled = Color3.fromRGB(180, 180, 0),
	    SliderRail = Color3.fromRGB(200, 200, 0),
	    DropdownFrame = Color3.fromRGB(40, 40, 0),
	    DropdownHolder = Color3.fromRGB(35, 35, 0),
	    DropdownBorder = Color3.fromRGB(100, 100, 0),
	    DropdownOption = Color3.fromRGB(255, 235, 0),
	    Keybind = Color3.fromRGB(255, 215, 0),
	    Input = Color3.fromRGB(255, 230, 0),
	    InputFocused = Color3.fromRGB(20, 20, 0),
	    InputIndicator = Color3.fromRGB(255, 255, 100),
	    Dialog = Color3.fromRGB(30, 30, 0),
	    DialogHolder = Color3.fromRGB(40, 40, 0),
	    DialogHolderLine = Color3.fromRGB(90, 90, 0),
	    DialogButton = Color3.fromRGB(255, 220, 0),
	    DialogButtonBorder = Color3.fromRGB(110, 110, 0),
	    DialogBorder = Color3.fromRGB(90, 90, 0),
	    DialogInput = Color3.fromRGB(255, 230, 0),
	    DialogInputLine = Color3.fromRGB(255, 255, 0),
	    Text = Color3.fromRGB(255, 255, 255), -- Bright white for contrast
